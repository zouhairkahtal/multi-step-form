function Nav() {
  return (
    <>
      <div className="w-1/3 h-full  rounded-xl bg-[url('../src/assets/images/bg-sidebar-desktop.svg')] bg-no-repeat bg-contain">
        <ul className=" w-52 pt-12 pl-8">
          <li className="mb-5">
            <div className="w-full flex  items-center ">
              <span className="mr-5 w-10 h-10 rounded-full bg-blue200 flex items-center justify-center">
                1
              </span>
              <div>
